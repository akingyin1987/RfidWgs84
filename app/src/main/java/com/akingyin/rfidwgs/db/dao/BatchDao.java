...
/** 
 * DAO for table "tb_batch".
*/
public class BatchDao extends AbstractDao<Batch, Long> {

    public static final String TABLENAME = "tb_batch";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tb_batch\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"tb_batch\"";
        db.execSQL(sql);
    }
